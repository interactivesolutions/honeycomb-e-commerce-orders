...
class HCECOrderShowController extends HCBaseController
{
    ...
    public function index($orderId)
    {
        ...
        $order->load(['details.warehouse', 'order_address', 'order_carriers.carrier', 'order_discount_code', 'order_state', 'order_payment_status', 'history' => function ($query) {
            $query->with('order_state', 'order_payment_status')->latest();
        }]);
