...
class CreateHcOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('hc_orders', function (Blueprint $table) {
            ...
            $table->string('user_address_id', 36)->nullable();
            ...
            $table->float('shipping_price', 20, 6)->nullable()->default("0.000000");
            $table->float('shipping_price_before_tax', 20, 6)->nullable()->default("0.000000");
            $table->text('carrier_note')->nullable();
